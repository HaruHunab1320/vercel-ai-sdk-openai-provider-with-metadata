  ...
  if (from && typeof from === "object" || typeof from === "function") {
    for (let key of __getOwnPropNames6(from))
      if (!__hasOwnProp9.call(to, key) && key !== except)
        __defProp9(to, key, { get: () => from[key], enumerable: !(desc = __getOwnPropDesc6(from, key)) || desc.enumerable });
  }
  return to;
};
...
var require_js_levenshtein = __commonJS5({
  "node_modules/js-levenshtein/index.js"(exports2, module2) {
    "use strict";
...
var import_js_levenshtein = __toESM6(require_js_levenshtein(), 1);
...
var SetupServerApi2 = class extends SetupServerApi {
  ...
  onRequest(request2) {
    try {
      (0, import_events.setMaxListeners)(
        Math.max(import_events.defaultMaxListeners, this.currentHandlers.length),
        request2.signal
      );
    } catch (error3) {
